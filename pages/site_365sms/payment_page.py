"""
Платёжная форма провайдера Heleket (паттерн 1 — проверка по логотипу).

Проверяет наличие логотипа Heleket на странице оплаты
и извлекает адрес крипто-кошелька для перевода.
"""

import allure

from pages.base_page import BasePage
from pages.site_365sms import SITE
import wallet_log
...
# Локатор содержит текст на русском языке — языкозависимый.
# Если интерфейс сайта переключится на другой язык, локатор сломается.
