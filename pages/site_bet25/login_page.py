"""
Страница авторизации на bet25.com.

Открывает главную, кликает на ссылку входа, заполняет форму
...
# Локатор по тексту — языкозависимый.
# Если интерфейс переключится на другой язык, локатор сломается.
