...
- Если видишь API запрос к процессингу в Network в момент открытия платёжной формы — запомни путь (например
  `/api/deposit/get_providers`) и структуру JSON ответа
