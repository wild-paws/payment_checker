...
Тесты для `site_365sms`, `site_starzspins`, `site_bet25` — примеры паттернов, по умолчанию пропускаются.
Закомментируй `@pytest.mark.skip` в нужном файле чтобы запустить.
